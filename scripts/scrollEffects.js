...
window.addEventListener("resize", () => {
    const { scrollTop, clientHeight, clientWidth } = document.body;
    translateScalePlanet1(clientWidth, clientHeight, scrollTop);
});
...
function translateScalePlanet1(clientWidth, clientHeight, scrollValue, scrollHeight) {
    let distanceY =
